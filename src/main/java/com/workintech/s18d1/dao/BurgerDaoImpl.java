...
public class BurgerDaoImpl implements BurgerDao{
    ...
    public Burger findById(long id) {
       ...
       if(burger == null){
           throw new BurgerErrorException("Burger not found:", HttpStatus.NOT_FOUND);
       }
       return burger;
    }
    ...
    public List<Burger> findByPrice(Integer price) {
        ...
        //Aynı isimli paramtre ve metoda gelen price birleştir.
        return query.getResultList();
    }

    @Override
    public List<Burger> findByBreadType(BreadType breadType) {
        TypedQuery<Burger> query = entityManager.createQuery("SELECT b FROM Burger b.breadType = :breadType ORDER BY b.name ASC", Burger.class);
