...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    private ResponseEntity<BurgerErrorResponse> handleException(BurgerErrorException exception){
        log.error("Burger excepiton occured! Exception details: ", exception);
    ...
    private ResponseEntity<BurgerErrorResponse> handleException(Exception exception){
        log.error("Excepiton occured! Exception details: ", exception);
        BurgerErrorResponse burgerErrorResponse = new BurgerErrorResponse(exception.getMessage());
